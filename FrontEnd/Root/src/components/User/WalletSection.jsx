...
const auth = useSelector((state)=>state.auth)
  ...
  <div className="flex flex-col gap-4">
    ...
    <div className="flex flex-col sm:flex-row justify-between items-center p-4 bg-gray-800 rounded-lg shadow-md">
  ...
  {isModalOpen && (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
      <div className="bg-gray-800 p-6 rounded-lg shadow-lg text-gray-100 max-w-xs w-full">
