...
const Login = () => {
  ...
  const handleSuccess = async (response) => {
    ...
    try {
      const res = await axios.post("https://api.rootstocks.site/account/google-login/", { token: idToken }
      );
  ...
  return (
    ...
    <div className="w-full md:w-1/2 bg-[#2D2D3D] flex items-center justify-center">
      <div className="w-full md:w-3/4 bg-[#1E1E2F] p-8 rounded-lg shadow-lg">
