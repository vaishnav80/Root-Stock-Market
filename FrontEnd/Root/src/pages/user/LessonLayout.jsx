...
<>
  ...
  {loading ? (
    <div className="flex min-h-screen bg-gray-900 text-white flex-col md:flex-row">
      <div
        className="w-full md:w-1/4 bg-gray-800 border-b md:border-r border-gray-700 overflow-y-auto"
        style={{ height: "100vh" }}
      >
      ...
      <div className="w-full md:w-3/4 overflow-y-auto" style={{ height: "100vh" }}>
        <div className="p-6">
                  ...
                  <div key={index} className="mb-8">
                    ...
                    {content.image && (
                      <div className="w-full md:w-2/4">
                        <img
                          src={`https://api.rootstocks.site${content.image}`}
                          alt={content.image}
